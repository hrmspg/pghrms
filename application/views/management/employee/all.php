...
<div class="x_panel">
    ...
    <?php echo form_open('Management/save_employee');?>
                ...
                <div class="clearfix"></div>
                  <br>
                <div class="item form-group">
                    <label for="password" class="control-label col-md-3">Bank Number</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="password" type="text" name="no_rek" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required="required">
                    </div>
                </div> 
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="password" type="text" name="bank" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required="required">
                    </div>
                </div> 
